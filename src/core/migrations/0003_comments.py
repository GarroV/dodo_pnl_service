...
COLUMNS = {
    ...
    "roles.visible_layers": "Регистры учёта, доступные роли. На этом держится RLS видимости",
    ...
    "allocation_rules.layer": "Регистр учёта правила: видимость закрыта ограничивающей политикой",
    ...
    "employment_terms.layer": "Переопределяет регистр учёта группы",
    ...
    "pay_components.layer": "Регистр учёта компонента: видимость закрыта ограничивающей политикой",
}
