...
# Подписи режимов здесь не живут: фразу про способ правок страница собирает
# целиком (T093). Кусок предложения, переводимый отдельно, складывается в
# осмысленную фразу только по-русски — в английском на его месте получалось
