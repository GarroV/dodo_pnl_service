...
VERSIONED_FIELDS = (
    ...
    "work_measure",
    # Из какой должности собраны условия (issue #181). Версионируется вместе с
    # остальным: человека переводят на другую должность, и прошлые месяцы
    # обязаны помнить, кем он был тогда.
    "position",
    # Часы по договору (issue #171): меняются вместе с условиями — перевели на
    # полставки, и норма по договору стала другой с той же даты.
    "contract_hours",
)
