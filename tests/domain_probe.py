...
MEANINGFUL_VALUES: dict[str, dict[str, str]] = {
    ...
    # Чек к наличному расходу (T184) — вторая двоичная колонка в схеме, и по
    # тому же доводу, что у бумаги: файл нулевой длины не чек, а неудавшаяся
    # загрузка. Значение названо здесь, потому что типового правила для `bytea`
    # у пробника нет.
    "cash_receipts": {"content": r"'\x00'::bytea", "byte_size": "1"},
}
